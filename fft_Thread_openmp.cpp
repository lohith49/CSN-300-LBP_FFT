//iterative algo optimized with threads and openmp
...
signed main() {
    ...
    cout << "Execution Time with combination of threads and openmp: " << duration_withThreads.count() << " ms" << endl;
        


    ofstream file("output_Thread_openmp.txt");
